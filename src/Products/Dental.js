...
const Dental = ({productItems3,handleAddProduct}) => {
  return (
    <>
    ...
    <Marquee direction={"right"} scrollAmount={"12"} className='marquee'>Order now of to get free delievery and 20% off on any product...</Marquee>
  
<div className="box">

   
    {productItems3.map((productItem) => (

    <div className="pic-div">

    <img src={productItem.image} alt="dental pic"/><p>{productItem.names}</p><br/>

    <h4>
        <i className="fa-solid fa-star" style={{color: "#b8961c"}}></i>&nbsp;{productItem.rating} | <i className="fa-solid fa-square-check" style={{color: "#511019"}}></i>&nbsp;{productItem.reviews}
    </h4>
    <br/>
    <div className="price">
